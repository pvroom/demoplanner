...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_sqlite__ = __webpack_require__(101);
...
let Synchronization = class Synchronization {
    ...
    // -----------------------------------
    DBCallQuery(SQLSelectQuery, SQLInsertQuery, SQLUpdateQuery, SQLDeleteQuery) {
...
SocialPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-social',template:/*ion-inline-start:"/Users/petervroom/demoplanner/src/pages/social/social.html"*/'<!--\n  Generated template for the Social page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Social Media</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content has tabs>\n\n<div class="">\n            <img src="assets/img/social.jpg" width="100%" height="auto" style="display: block; margin-left: auto; margin-right: auto;">\n        </div>\n\n\n        <ion-list>\n          <ion-item href="#" onclick="window.open(\'https://www.facebook.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left >\n              <img src="assets/img/facebook.png">\n            </ion-avatar>\n            <h2>Facebook</h2>\n          </ion-item>\n\n          <ion-item href="#" onclick="window.open(\'https://twitter.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/twitter.png">\n            </ion-avatar>\n            <h2>Twitter</h2>\n          </ion-item>\n\n          <ion-item href="#" onclick="window.open(\'https://www.linkedin.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/linkedin.png">\n            </ion-avatar>\n            <h2>Linkedin</h2>\n          </ion-item>\n\n          <ion-item href="#" onclick="window.open(\'https://www.instagram.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/instagram.jpeg">\n            </ion-avatar>\n            <h2>Instagram</h2>\n          </ion-item>\n\n\n          <ion-item href="#" onclick="window.open(\'https://www.flickr.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/flickr.png">\n            </ion-avatar>\n            <h2>Flickr</h2>\n          </ion-item>\n\n          <ion-item href="#" onclick="window.open(\'https://www.pinterest.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/pinterest.png">\n            </ion-avatar>\n            <h2>Pinterest</h2>\n          </ion-item>\n\n          <ion-item href="#" onclick="window.open(\'https://www.youtube.com/\', \'_system\', \'location=yes\'); return false;">\n            <ion-avatar item-left>\n              <img src="assets/img/youtube.png">\n            </ion-avatar>\n            <h2>YouTube</h2>\n          </ion-item>\n\n\n        </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Users/petervroom/demoplanner/src/pages/social/social.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_sqlite__ = __webpack_require__(101);
...
let Database = class Database {
    constructor(pltfrm, httpCall, alertCtrl, sqlite, localstorage) {
        this.pltfrm = pltfrm;
        this.httpCall = httpCall;
        this.alertCtrl = alertCtrl;
        this.sqlite = sqlite;
    ...
    getLecturesByDay(dayID, listingType, AttendeeID) {
        ...
        if (this.DevicePlatform == "iOS" || this.DevicePlatform == "Android") {
            ...
            SQLquery = SQLquery + "lr.RoomDisplayName AS RoomName, c.cs_credits, c.subject, c.room_capacity, s.itID AS OnAgenda, ";
            SQLquery = SQLquery + "(SELECT COUNT(acID) AS Attendees FROM attendee_courses ac WHERE ac.session_id = c.session_id) AS Attendees, ";
            ...
            switch (listingType) {
                case "Lectures":
                    SQLquery = SQLquery + "WHERE ce_credits_type = 'Lecture' AND c.ActiveYN = 'Y' ";
                    SQLquery = SQLquery + "AND session_start_time LIKE '" + selectedDate + "%'";
                    break;
                case "Participation":
                    SQLquery = SQLquery + "WHERE ce_credits_type = 'Participation' AND c.ActiveYN = 'Y' ";
                    SQLquery = SQLquery + "AND session_start_time LIKE '" + selectedDate + "%'";
                    break;
                case "Receptions and Events":
                    SQLquery = SQLquery + "WHERE ce_credits_type = '' AND c.ActiveYN = 'Y' ";
                    SQLquery = SQLquery + "AND session_start_time LIKE '" + selectedDate + "%' ";
    ...
    getLectureData(flags, AttendeeID) {
        ...
        if (this.DevicePlatform == "iOS" || this.DevicePlatform == "Android") {
            ...
            if (listingType == "li3") { // All sessions list
                ...
                SQLquery = SQLquery + "FROM courses c ";
                SQLquery = SQLquery + "INNER JOIN lookup_rooms lr ON c.room_number = lr.RoomName ";
                SQLquery = SQLquery + "WHERE session_start_time LIKE '" + selectedDate + "%' ";
            ...
            if (listingType == "dt") { // Details of session
                ...
                SQLquery = SQLquery + "c.primary_speaker, c.other_speakers, lr.RoomDisplayName AS RoomName, lr.FloorNumber, lr.RoomX, lr.RoomY, c.description, c.course_id, c.ce_credits_type, c.HandoutFilename, ";
    ...
    getAgendaData(flags, AttendeeID) {
        ...
        if (this.DevicePlatform == "iOS" || this.DevicePlatform == "Android") {
            ...
            if (listingType == "li") { // List of agenda items
                ...
                SQLquery = SQLquery + "AND c.ActiveYN = 'Y' ";
                SQLquery = SQLquery + "ORDER BY EventStartTime, EventID ";
                // Version 3 (2019-06-12)
                SQLquery = "SELECT DISTINCT itID, EventID, mtgID, Time_Start AS EventStartTime, Time_End AS EventEndTime, Location AS EventLocation, Description AS EventDescription, SUBJECT AS EventName, Date_Start AS EventDate, '0' AS Attendees, '0' AS Waitlist, '100' AS RoomCapacity ";
                SQLquery = SQLquery + "FROM itinerary WHERE Date_Start = '" + selectedDay + "' AND AttendeeID = '" + AttendeeID + "' ";
                SQLquery = SQLquery + "AND EventID = '0' ";
                SQLquery = SQLquery + "AND UpdateType != 'Delete' ";
                SQLquery = SQLquery + "UNION ";
                SQLquery = SQLquery + "SELECT DISTINCT '0' AS itID, EventID, mtgID, TIME(session_start_time) AS EventStartTime, TIME(session_end_time) AS EventEndTime, lr.RoomDisplayName AS EventLocation,  ";
                SQLquery = SQLquery + "c.Description AS EventDescription, c.session_title AS EventName, DATE(session_start_time) AS EventDate, ";
                SQLquery = SQLquery + "(SELECT COUNT(acID) AS Attendees FROM attendee_courses ac ";
                SQLquery = SQLquery + " INNER JOIN courses c ON ac.session_id = c.session_id ";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators_map__ = __webpack_require__(613);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__database_database__ = __webpack_require__(417);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__help_help__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__notes_notes__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__myagendafull_myagendafull__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__myagenda_myagenda__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__evaluationconference_evaluationconference__ = __webpack_require__(105);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_database_database__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_synchronization_synchronization__ = __webpack_require__(104);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__speakers_speakers__ = __webpack_require__(169);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        this.databaseprovider.getExhibitorData(flags).then(data => {
            ...
            if (data['length'] > 0) {
                ...
                for (var i = 0; i < data['length']; i++) {
                    ...
                    var imageAvatar = "https://demoplanner.convergence-us.com/AdminGateway/2019/images/ExhibitorLogos/" + data[i].imageFilename;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__social_social__ = __webpack_require__(170);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
NetworkingPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-networking',template:/*ion-inline-start:"/Users/petervroom/demoplanner/src/pages/networking/networking.html"*/'<ion-header>\n	<ion-navbar color="primary">\n		<button ion-button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>Networking</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content class="networking" style="background:#0b172a">\n\n	<ion-grid>\n	\n		<ion-row style="background:#283747">\n			<ion-col align-self-center style="background:#283747; height:100%">\n				<ion-item no-lines detail-none class="buttonShape" style="background:#283747" (click)="NavigateTo(\'Attendees\')" id="program-list-item1">\n					<ion-icon name="contacts" class="buttonIconsL"></ion-icon>\n					<h2>Attendees</h2>\n				</ion-item>\n			</ion-col>\n\n			<ion-col align-self-center style="background:#cc5d1d; height:100%">\n				<ion-item no-lines detail-none class="buttonShape" style="background:#cc5d1d"  (click)="NavigateTo(\'Conversations\')" id="program-list-item3">\n					<ion-icon name="chatbubbles" class="buttonIconsL"></ion-icon>\n					<h2>Conversations</h2>\n					<p *ngIf=NewMessagesIndicator style="color:#fff;">{{NewMessagesCounter}} New Messages</p>\n				</ion-item>\n			</ion-col>\n		</ion-row>\n		\n		<ion-row style="background:#cc5d1d"> \n			<ion-col align-self-center style="background:#cc5d1d; height:100%">\n				<button ion-item no-lines detail-none class="buttonShape" style="background:#cc5d1d;" (click)="NavigateTo(\'MyProfile\')" id="program-list-item5">\n					<ion-icon name="contact" class="buttonIconsL"></ion-icon>\n					<h2>My Profile</h2>\n				</button>\n			</ion-col>\n			\n			<ion-col align-self-center style="background:#283747; height:100%">\n				<button ion-item no-lines detail-none class="buttonShape" style="background:#283747" (click)="NavigateTo(\'Notifications\')" id="program-list-item2">\n					<ion-icon name="alert" class="buttonIconsL"></ion-icon>\n					<h2>Notifications</h2>\n				</button>\n			</ion-col>\n		</ion-row>\n		\n		<ion-row style="background:#283747">\n			<ion-col align-self-center style="background:#283747; height:100%">\n				<button ion-item no-lines detail-none class="buttonShape" style="background:#283747" (click)="NavigateTo(\'ActivityFeed\')" id="program-list-item5">\n					<ion-icon name="chatboxes" class="buttonIconsL"></ion-icon>\n					<h2>Activities Feed</h2>\n				</button>\n			</ion-col>\n			\n			<ion-col align-self-center style="background:#cc5d1d; height:100%">\n				<button ion-item no-lines detail-none class="buttonShape" style="background:#cc5d1d;" (click)="NavigateTo(\'SocialMedia\')" id="program-list-item2">\n					<ion-icon name="text" class="buttonIconsL"></ion-icon>\n					<h2>Social Media</h2>\n				</button>\n			</ion-col>\n		</ion-row>\n			\n	</ion-grid>\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"/Users/petervroom/demoplanner/src/pages/networking/networking.html"*/,
        changeDetection: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectionStrategy"].OnPush
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_chat_service__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_localstorage_localstorage__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_synchronization_synchronization__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__notes_notes__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__myagenda_myagenda__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__myagendafull_myagendafull__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__evaluationconference_evaluationconference__ = __webpack_require__(105);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let LoginPage = class LoginPage {
    constructor(navCtrl, navParams, 
    //private http: HTTP, 
    http, alertCtrl, storage, cd, syncprovider, localstorage, events, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.http = http;
        this.alertCtrl = alertCtrl;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_http__ = __webpack_require__(863);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_status_bar__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_sqlite__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_component__ = __webpack_require__(864);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_onesignal__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ionic_img_viewer__ = __webpack_require__(865);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_camera__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_splash_screen__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ionic_text_avatar__ = __webpack_require__(872);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_ionic_image_loader__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_ng2_charts__ = __webpack_require__(475);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_ng2_file_upload__ = __webpack_require__(874);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_ionic2_alpha_scroll__ = __webpack_require__(877);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_ionic2_alpha_scroll___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_19_ionic2_alpha_scroll__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_keyboard__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__providers_database_database__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__providers_synchronization_synchronization__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pipes_relative_time__ = __webpack_require__(882);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_post_service__ = __webpack_require__(897);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__services_user_service__ = __webpack_require__(899);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__services_chat_service__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_home_home__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_conferencecity_conferencecity__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_social_social__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_more_more__ = __webpack_require__(416);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_slider_slider__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_help_help__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_speakers_speakers__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_program_program__ = __webpack_require__(418);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_map_map__ = __webpack_require__(420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_login_login__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_exhibitors_exhibitors__ = __webpack_require__(421);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_notes_notes__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pages_database_database__ = __webpack_require__(417);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__pages_evaluationconference_evaluationconference__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__pages_myagenda_myagenda__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_myagendafull_myagendafull__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_educationdetails_educationdetails__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_activity_activity__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__pages_profile_profile__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pages_notifications_notifications__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pages_attendees_attendees__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__pages_networking_networking__ = __webpack_require__(422);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__pages_attendeebookmarks_attendeebookmarks__ = __webpack_require__(465);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__pages_conversation_conversation__ = __webpack_require__(472);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_30__pages_social_social__["a" /* SocialPage */],
            __WEBPACK_IMPORTED_MODULE_31__pages_more_more__["a" /* MorePage */],
            __WEBPACK_IMPORTED_MODULE_32__pages_slider_slider__["a" /* SliderPage */],
            __WEBPACK_IMPORTED_MODULE_33__pages_help_help__["a" /* HelpPage */],
            __WEBPACK_IMPORTED_MODULE_34__pages_speakers_speakers__["a" /* SpeakersPage */],
            __WEBPACK_IMPORTED_MODULE_35__pages_program_program__["a" /* ProgramPage */],
            __WEBPACK_IMPORTED_MODULE_36__pages_map_map__["a" /* MapPage */],
            __WEBPACK_IMPORTED_MODULE_37__pages_login_login__["a" /* LoginPage */],
            __WEBPACK_IMPORTED_MODULE_29__pages_conferencecity_conferencecity__["a" /* ConferenceCityPage */],
            __WEBPACK_IMPORTED_MODULE_38__pages_exhibitors_exhibitors__["a" /* ExhibitorsPage */],
            __WEBPACK_IMPORTED_MODULE_39__pages_notes_notes__["a" /* NotesPage */],
            __WEBPACK_IMPORTED_MODULE_40__pages_database_database__["a" /* DatabasePage */],
            __WEBPACK_IMPORTED_MODULE_44__pages_educationdetails_educationdetails__["a" /* EducationDetailsPage */],
            __WEBPACK_IMPORTED_MODULE_41__pages_evaluationconference_evaluationconference__["a" /* EvaluationConference */],
            //FloorplanMappingPage,
            __WEBPACK_IMPORTED_MODULE_42__pages_myagenda_myagenda__["a" /* MyAgenda */],
            __WEBPACK_IMPORTED_MODULE_43__pages_myagendafull_myagendafull__["a" /* MyAgendaFull */],
            __WEBPACK_IMPORTED_MODULE_51__pages_conversation_conversation__["a" /* ConversationPage */],
            __WEBPACK_IMPORTED_MODULE_47__pages_notifications_notifications__["a" /* NotificationsPage */],
            __WEBPACK_IMPORTED_MODULE_48__pages_attendees_attendees__["a" /* AttendeesPage */],
            __WEBPACK_IMPORTED_MODULE_50__pages_attendeebookmarks_attendeebookmarks__["a" /* AttendeeBookmarksPage */],
            __WEBPACK_IMPORTED_MODULE_49__pages_networking_networking__["a" /* NetworkingPage */],
            __WEBPACK_IMPORTED_MODULE_24__pipes_relative_time__["a" /* RelativeTime */],
            ...
            __WEBPACK_IMPORTED_MODULE_45__pages_activity_activity__["a" /* ActivityPage */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_19_ionic2_alpha_scroll__["IonAlphaScrollModule"],
            __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["b" /* HttpClientModule */],
            __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["a" /* IonicStorageModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_16_ionic_image_loader__["b" /* IonicImageLoader */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["IonicModule"].forRoot(__WEBPACK_IMPORTED_MODULE_10__app_component__["a" /* MyApp */], { tabsPlacement: 'bottom' }, {
                links: [
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_22__providers_localstorage_localstorage__["a" /* Localstorage */],
            ...
            __WEBPACK_IMPORTED_MODULE_21__providers_database_database__["a" /* Database */],
            __WEBPACK_IMPORTED_MODULE_9__ionic_native_sqlite__["a" /* SQLite */],
            __WEBPACK_IMPORTED_MODULE_25__services_post_service__["a" /* PostService */],
            ...
            __WEBPACK_IMPORTED_MODULE_23__providers_synchronization_synchronization__["a" /* Synchronization */]
        ]
    })
], AppModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_database_database__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__myagendafull_myagendafull__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__educationdetails_educationdetails__ = __webpack_require__(65);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__myagenda_myagenda__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_localstorage_localstorage__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_synchronization_synchronization__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__ = __webpack_require__(615);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_status_bar__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_sqlite__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__more_more__ = __webpack_require__(416);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__help_help__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__program_program__ = __webpack_require__(418);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__conferencecity_conferencecity__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__social_social__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__speakers_speakers__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__map_map__ = __webpack_require__(420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__exhibitors_exhibitors__ = __webpack_require__(421);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__notes_notes__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__myagenda_myagenda__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__login_login__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__networking_networking__ = __webpack_require__(422);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__activity_activity__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__profile_profile__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__cetracking_cetracking__ = __webpack_require__(476);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__educationdetails_educationdetails__ = __webpack_require__(65);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HomePage = class HomePage {
    constructor(navCtrl, alertCtrl, nav, loadingCtrl, toastCtrl, appCtrl, storage, databaseprovider, statusBar, syncprovider, cd, pltfrm, sqlite, localstorage) {
        this.navCtrl = navCtrl;
        this.alertCtrl = alertCtrl;
        this.nav = nav;
        this.loadingCtrl = loadingCtrl;
        ...
        this.cetrackingPage = __WEBPACK_IMPORTED_MODULE_24__cetracking_cetracking__["a" /* CetrackingPage */];
    ...
    ionViewWillEnter() {
        ...
        if (LoginName != '' && LoginName != null && LoginName != 'undefined') {
            ...
            this.localstorage.setLocalValue("AgendaDays", "3");
            this.localstorage.setLocalValue("AgendaDates", "2019-04-24|2019-04-25|2019-04-26|");
            this.localstorage.setLocalValue("AgendaDayButtonLabels", "4/24|4/25|4/26|");
        }
        this.upcomingAgendaItems = [];
        this.cd.markForCheck();
        // Temporary use variables
    ...
    ionViewDidEnter() {
        ...
        if (this.DevicePlatform != "Browser") {
            ...
            if (AutoSync != '0') {
                ...
                if (LastDirectChatCheck == '' || LastDirectChatCheck === null) {
                    LastDirectChatCheck = '2019-06-11T00:00:01Z';
                }
        ...
        if (AutoSyncReset == '' || AutoSyncReset == null) {
            ...
            if (this.DevicePlatform != "Browser") {
                ...
                this.localstorage.setLocalValue('LastSync', '2019-06-11T00:00:01Z');
    ...
    startDirectChatMonitoring() {
        ...
        this.DCsubscription = __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].interval(10000).subscribe(x => {
            // Toast message for indicating a new chat message
            let toast = this.toastCtrl.create({
                message: 'New chat message received',
                duration: 2500,
                position: 'top'
            });
            var x = this.appCtrl.getActiveNavs()[0]._views.length - 1;
            console.log('Home: Direct Chat Monitoring, Current view [' + x + ']: ' + this.appCtrl.getActiveNavs()[0]._views[x].component.name);
            var DisplayDCToast = true;
            if (this.appCtrl.getActiveNavs()[0]._views[x].component.name === 'ConversationPage') {
                DisplayDCToast = false;
            }
            // Previously successful sync time
            var LastDirectChatCheck = this.localstorage.getLocalValue('LastDirectChatCheck');
            if (LastDirectChatCheck == '' || LastDirectChatCheck === null) {
            ...
            this.syncprovider.DirectChatMonitor(LastDirectChatCheck, ThisDirectChatCheck).then(data => {
                ...
                var PreviousDCMessage = this.localstorage.getLocalValue('DirectChatMonitoringString');
                var CurrentDCMessage = JSON.stringify(data);
                if (CurrentDCMessage == PreviousDCMessage || data[0].NewMessages == "0") {
                    DisplayDCToast = false;
                }
                console.log('Home: Direct Chat Monitoring message: ' + CurrentDCMessage);
                this.localstorage.setLocalValue('DirectChatMonitoringString', JSON.stringify(data));
                console.log('Home: Direct Chat Monitoring message count: ' + data[0].NewMessages);
                console.log('Home: Direct Chat Monitoring toast status: ' + DisplayDCToast);
    ...
    startAutoSync() {
        ...
        this.subscription = __WEBPACK_IMPORTED_MODULE_7_rxjs_Rx__["Observable"].interval(60000).subscribe(x => {
            ...
            var LastSync3 = this.localstorage.getLocalValue('LastSync');
            if (LastSync3 == '' || LastSync3 === null) {
                LastSync3 = '2019-06-11T00:00:01Z';
            }
            var LastSync2 = new Date(LastSync3).toUTCString();
            var LastSync = dateFormat(LastSync2, "UTC:yyyy-mm-dd'T'HH:MM:ss'Z'");
            // Current sync time in UTC
    ...
    EventDetails(EventID) {
        ...
        if (storeEventID == "0" && storePersonalEventID == "0") {
            ...
            if (storeEventID == "0") {
                ...
                this.localstorage.setLocalValue('EventID', storeEventID);
                // Navigate to Education Details page
                this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_25__educationdetails_educationdetails__["a" /* EducationDetailsPage */], { EventID: storeEventID }, { animate: true, direction: 'forward' });
            }
        }
    }
    ;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_status_bar__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_splash_screen__ = __webpack_require__(463);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_onesignal__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_keyboard__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_notes_notes__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_myagenda_myagenda__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_myagendafull_myagendafull__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_evaluationconference_evaluationconference__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_educationdetails_educationdetails__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_attendeebookmarks_attendeebookmarks__ = __webpack_require__(465);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let MyApp = class MyApp {
    ...
    events, menuCtrl, cd, statusBar, databaseprovider, localstorage) {
        ...
        this.pages = [
            ...
            { title: 'Full Agenda', icon: 'calendar', component: __WEBPACK_IMPORTED_MODULE_13__pages_myagendafull_myagendafull__["a" /* MyAgendaFull */], naventry: 'MyAgendaFull' },
            ...
            { title: 'Bookmarks', icon: 'bookmark', component: __WEBPACK_IMPORTED_MODULE_16__pages_attendeebookmarks_attendeebookmarks__["a" /* AttendeeBookmarksPage */], naventry: 'Bookmarks' },
            { title: 'Event Survey', icon: 'bookmarks', component: __WEBPACK_IMPORTED_MODULE_14__pages_evaluationconference_evaluationconference__["a" /* EvaluationConference */], naventry: 'EventSurvey' },
            { title: 'Sign In / Out', icon: 'log-in', component: __WEBPACK_IMPORTED_MODULE_10__pages_login_login__["a" /* LoginPage */], naventry: 'Login' }
    ...
    initializeApp() {
        this.pltfrm.ready().then(() => {
            ...
            this.statusBar.backgroundColorByHexString('#283747');
    ...
    NavigateToAuthenticatedPage(PageID) {
        ...
        if (AttendeeID != '' && AttendeeID != null) {
            ...
            switch (PageID) {
                case "MyAgenda":
                    this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_12__pages_myagenda_myagenda__["a" /* MyAgenda */], {}, { animate: true, direction: 'forward' });
                    break;
                case "MyAgendaFull":
                    this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__pages_myagendafull_myagendafull__["a" /* MyAgendaFull */], {}, { animate: true, direction: 'forward' });
                    break;
                case "CETracking":
                    this.menuCtrl.close();
                    this.navCtrl.push('CetrackingPage', {}, { animate: true, direction: 'forward' });
                    break;
                case "Notes":
                    this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__pages_notes_notes__["a" /* NotesPage */], {}, { animate: true, direction: 'forward' });
                    break;
            }
        }
        else {
            ...
            this.localstorage.setLocalValue('ForwardingPage', PageID);
            this.menuCtrl.close();
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_10__pages_login_login__["a" /* LoginPage */], {}, { animate: true, direction: 'forward' });
        }
    }
    EventDetails(EventID) {
        ...
        if (storeEventID == "0" && storePersonalEventID == "0") {
            ...
            if (storeEventID == "0") {
                ...
                // Navigate to Education Details page
                this.menuCtrl.close();
                this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__pages_educationdetails_educationdetails__["a" /* EducationDetailsPage */], { EventID: storeEventID }, { animate: true, direction: 'forward' });
            }
        }
    }
    ;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_date_fns_distance_in_words_to_now__ = __webpack_require__(883);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_posts__ = __webpack_require__(898);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_users__ = __webpack_require__(900);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
