...
Ionic.loadBundle("./chunk6.js", ["exports"], function (n) { window.Ionic.h; var e = CustomEvent; function i(n, e) {
    ...
    return __awaiter(this, void 0, void 0, function () { var e; return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e = _a.sent();
                a(n.enteringEl, n.leavingEl);
                return [4 /*yield*/, function (n, e) { var i = e.progressAnimation, a = new Promise(function (e) { return n.onFinish(e); }); return i ? (n.progressStart(), i(n)) : n.play(), a; }(e, n)];
            case 3: return [2 /*return*/, (_a.sent(), e.hasCompleted && t(n.enteringEl, n.leavingEl), e)];
        }
    }); });
}(n) : function (n) {
    return __awaiter(this, void 0, void 0, function () { var e, o; return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, function (n) {
                        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Promise.all([l(n.enteringEl), l(n.leavingEl)])];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, i(n.viewIsReady, n.enteringEl)];
                                case 2:
            ...
            case 1: return [2 /*return*/, (_a.sent(), a(e, o), void t(e, o))];
        }
    }); });
}(n); }; });
